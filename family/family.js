...
// ----------------------
const WORDS = [
  { text: "Mutter", phon: "MOO-ter", translations: { en: "Mother", fr: "Mère", de: "Mutter" }, accept: ["mutter"] },
  { text: "Vater", phon: "FAH-ter", translations: { en: "Father", fr: "Père", de: "Vater" }, accept: ["vater"] },
  { text: "Eltern", phon: "EL-tern", translations: { en: "Parents", fr: "Parents", de: "Eltern" }, accept: ["eltern"] },
  { text: "Kind", phon: "kint", translations: { en: "Child", fr: "Enfant", de: "Kind" }, accept: ["kind"] },
  { text: "Sohn", phon: "zohn", translations: { en: "Son", fr: "Fils", de: "Sohn" }, accept: ["sohn"] },
  { text: "Tochter", phon: "TOKH-ter", translations: { en: "Daughter", fr: "Fille", de: "Tochter" }, accept: ["tochter"] },
  { text: "Bruder", phon: "BROO-der", translations: { en: "Brother", fr: "Frère", de: "Bruder" }, accept: ["bruder"] },
  { text: "Schwester", phon: "SHVES-ter", translations: { en: "Sister", fr: "Sœur", de: "Schwester" }, accept: ["schwester"] },
  { text: "Oma", phon: "OH-mah", translations: { en: "Grandma", fr: "Grand-mère", de: "Oma" }, accept: ["oma"] },
  { text: "Opa", phon: "OH-pah", translations: { en: "Grandpa", fr: "Grand-père", de: "Opa" }, accept: ["opa"] },
];
