...
const WORDS = [
  { text: "rot", phon: "roht", translations: { en: "red", fr: "rouge", de: "rot" }, accept: ["rot"] },
  { text: "blau", phon: "blow", translations: { en: "blue", fr: "bleu", de: "blau" }, accept: ["blau"] },
  { text: "grün", phon: "gruen", translations: { en: "green", fr: "vert", de: "grün" }, accept: ["grün", "grun"] },
  { text: "gelb", phon: "gelp", translations: { en: "yellow", fr: "jaune", de: "gelb" }, accept: ["gelb"] },
  { text: "schwarz", phon: "shvarts", translations: { en: "black", fr: "noir", de: "schwarz" }, accept: ["schwarz"] },
  { text: "weiß", phon: "vice", translations: { en: "white", fr: "blanc", de: "weiß" }, accept: ["weiß", "weiss"] },
  { text: "grau", phon: "grow", translations: { en: "gray", fr: "gris", de: "grau" }, accept: ["grau"] },
  { text: "braun", phon: "brown", translations: { en: "brown", fr: "marron", de: "braun" }, accept: ["braun"] },
  { text: "orange", phon: "oh-RAN-jeh", translations: { en: "orange", fr: "orange", de: "orange" }, accept: ["orange"] },
  { text: "lila", phon: "LEE-lah", translations: { en: "purple", fr: "violet", de: "lila" }, accept: ["lila"] },
];
