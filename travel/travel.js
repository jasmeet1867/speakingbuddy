...
const WORDS = [
  { text: "Bahnhof", phon: "BAHN-hohf", translations: { en: "Train station", fr: "Gare", de: "Bahnhof" }, accept: ["bahnhof"] },
  { text: "Flughafen", phon: "FLOOG-hah-fen", translations: { en: "Airport", fr: "Aéroport", de: "Flughafen" }, accept: ["flughafen"] },
  { text: "Ticket", phon: "TIK-et", translations: { en: "Ticket", fr: "Billet", de: "Ticket" }, accept: ["ticket"] },
  { text: "Reisepass", phon: "RYE-zeh-pass", translations: { en: "Passport", fr: "Passeport", de: "Reisepass" }, accept: ["reisepass"] },
  { text: "Koffer", phon: "KOF-fer", translations: { en: "Suitcase", fr: "Valise", de: "Koffer" }, accept: ["koffer"] },
  { text: "Hotel", phon: "hoh-TELL", translations: { en: "Hotel", fr: "Hôtel", de: "Hotel" }, accept: ["hotel"] },
  { text: "Straße", phon: "SHTRAH-suh", translations: { en: "Street", fr: "Rue", de: "Straße" }, accept: ["straße", "strasse"] },
  { text: "Karte", phon: "KAR-teh", translations: { en: "Map", fr: "Carte", de: "Karte" }, accept: ["karte"] },
  { text: "U-Bahn", phon: "OO-bahn", translations: { en: "Subway", fr: "Métro", de: "U-Bahn" }, accept: ["u-bahn", "ubahn"] },
  { text: "Bushaltestelle", phon: "boosh-HAL-teh-shtel-leh", translations: { en: "Bus stop", fr: "Arrêt de bus", de: "Bushaltestelle" }, accept: ["bushaltestelle"] },
];
